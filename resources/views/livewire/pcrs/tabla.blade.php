<div>
        ...
        <x-slot name='content'>
            <form class="grid gap-3" wire:submit="create">
                ...
                <div class="">
                    ...
                    <hr class="mb-2">
                    <ul
                        class="grid grid-cols-3 place-items-center max-md:grid-cols-1 max-md:place-items-start overflow-auto max-h-36 v-scroll">
                        @foreach ($especies as $especie)
                            <li><x-checkbox wire:model="selectedTagsEspecie" value="{{ $especie->id }} " /><span
                                    class="text-white">{{ $especie->nombre }}</span></li>
                        @endforeach
                    </ul>
                ...
                <div class="">
                    ...
                    <ul
                        ...
                        @foreach ($equipos as $equipo)
                            <li><x-checkbox wire:model="selectedTagsEquipo" value="{{ $equipo->id }} " /><span
                                    class="text-white">{{ $equipo->inventario }}-{{ $equipo->nombre }}</span></li>
                        @endforeach
                    </ul>
            ...
            <div class="grid gap-3">
                ...
                <div class="grid grid-cols-2 max-md:grid-cols-1 gap-5 place-items-center">
                    <div class="">
                        <label for="">Sanitizo:</label>
                        @if ($sanitizado == 1)
                            <x-input type='checkbox' checked="{{ $sanitizado }}" wire:model='VerPcr.sanitizo'
                                disabled />
                        @else
                    ...
                    <div class="">
                        <label for="">Tiempo Uv</label>
                        @if ($tiempouvs == 1)
                            <x-input type='checkbox' checked="{{ $tiempouvs }}" wire:model='VerPcr.tiempouv'
                                disabled />
                        @else
            ...
            <form class="grid gap-3" wire:submit="update">
                ...
                <div class="grid grid-cols-2 max-md:grid-cols-1 gap-5 place-items-center">
                    <div class="">
                        <label for="">Sanitizo:</label>
                        @if ($sanitizado == 1)
                            <x-input type='checkbox' checked="{{ $sanitizado }}" wire:model='pcrEdit.sanitizo'
                                 />
                        @else
                    ...
                    <div class="">
                        <label for="">Tiempo Uv</label>
                        @if ($tiempouvs == 1)
                            <x-input type='checkbox' checked="{{ $tiempouvs }}" wire:model='pcrEdit.tiempouv'
                                 />
                        @else
                ...
                <div class="">
                    ...
                    <ul
                        class="grid grid-cols-3 place-items-center max-md:grid-cols-1 max-md:place-items-start gap-5 overflow-auto max-h-36 v-scroll">
                        @foreach ($especies as $especie)
                            <li><x-checkbox wire:model="pcrEdit.selectedTagsEspecie"
                                    value="{{ $especie->id }} " /><span
                                    class="text-white">{{ $especie->nombre }}</span></li>
                        @endforeach
                    </ul>
                ...
                <div class="">
                    ...
                    <ul
                        class="grid grid-cols-3 place-items-center max-md:grid-cols-1 max-md:place-items-start gap-5 overflow-auto max-h-36 v-scroll">
                        @foreach ($equipos as $equipo)
                            <li><x-checkbox wire:model="pcrEdit.selectedTagsEquipo"
                                    value="{{ $equipo->id }} " /><span
    ...
    <x-dialog-modal wire:model="vercion_pcr">
        ...
        <x-slot name='footer'>
            <x-danger-button wire:click="cerrar_vercion">Cerrar</x-danger-button>
        </x-slot>
    </x-dialog-modal>
</div>
