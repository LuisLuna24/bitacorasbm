            ...
            <form wire:submit.prevent="register" class="bg-slate-300 dark:bg-slate-800 p-5 rounded-md mt-3">
                ...
                @if ($currentStep == 4)
                    <fieldset class="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <div class="flex flex-col">
                            <label for="">No. Registro:</label>
                            <x-input wire:model="no_registro" placeholder="Numero de la bitacora" disabled />
                        </div>
                        <div class="flex flex-col">
                            <label for="">Análisis:</label>
                            <x-select type="text" wire:model="analisis" disabled >
                                <option value="" disabled>Seleccione una opción</option>
                                @foreach ($analises as $item)
                                    <option value="{{ $item->id }}">{{ $item->nombre }}</option>
                                @endforeach
                        ...
                        <div class="flex flex-col">
                            <label for="">Sanitizo:</label>
                            <x-select type="text" wire:model="sanitizo" disabled >
                                <option value="" disabled>Seleccione una opción</option>
                                <option value="1">Si</option>
                                <option value="2">No</option>
                            </x-select>
                        ...
                        <div class="flex flex-col">
                            <label for="">Tiempo UV:</label>
                            <x-select type="text" wire:model="tiempouv" disabled >
                                <option value="" disabled>Seleccione una opción</option>
                                <option value="1">Si</option>
                                <option value="2">No</option>
                            </x-select>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-3 mt-3">
                        <div class="flex flex-col">
                            <label for="">Agaroza:</label>
                            <x-input wire:model="agaroza" disabled />
                        </div>
                        <div class="flex flex-col">
                            <label for="">Tiempo:</label>
                            <x-input wire:model="tiempo" placeholder="(minutos)" disabled />
                        </div>

                        <div class="flex flex-col">
                            <label for="">Voltaje:</label>
                            <x-input wire:model="voltaje" disabled />
                        </div>
                    </div>
                    <div class="mt-5 mb-5 border-b-2 border-gray-300 dark:border-gray-700">
                        <p>Especies:</p>
                    </div>
                    <x-table>
                        <x-slot name="titles">
