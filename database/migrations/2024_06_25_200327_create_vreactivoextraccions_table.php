...
return new class extends Migration
{
    ...
    {
        Schema::create('vreactivoextraccions', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('reactivoextraccions_id');
            $table->foreign('reactivoextraccions_id')->references('id')->on('reactivoextraccions')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('vreactivoextraccions');
    }
};
