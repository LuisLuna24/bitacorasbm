...
return new class extends Migration
{
    ...
    {
        Schema::create('vreactivopcreals', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('reactivopcreals_id');
            $table->foreign('reactivopcreals_id')->references('id')->on('reactivopcreals')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('vreactivopcreals');
    }
};
